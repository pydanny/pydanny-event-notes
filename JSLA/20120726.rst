...
* Techniques to use WordPress or other traditional CMS with this type of JS application. .. note:: CMS are not ideal for this sort of API thing unless your app is supposed to replace a CMS.
...
* How touse Titanium with DOM-based JS